...
#define STRING_CONFIG_H_AUTHOR "(WagnerMaker Euclides v 0.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pitagoras printer3Dx"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4840, 110 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 200, 200, 25, 500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, -9, -2 }
...
//
// FYSETC variant of the   graphic controller with SD support
